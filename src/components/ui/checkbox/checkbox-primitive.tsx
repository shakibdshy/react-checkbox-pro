    ...
    <>
      {helperTextProp || errorMessage ? (
        <div className="space-y-1.5">
            ...
            <div className={cn("relative", "flex items-center", "gap-2")}>
              ...
              >
                {indeterminate ? (
                  ...
                  checkedIcon ||
                  icon || (
                    <DefaultCheckIcon isWithoutTailwind={isWithoutTailwind} />
                  )
                )}
              </div>
            </div>
          ...
          {(helperTextProp || errorMessage) && (
            <p id={helperTextId} className={helperTextClass}>
        ...
        <label
          className={cn(wrapperClass, (disabled || group?.disabled) && "group")}
        >
          <div className={cn("relative", "flex items-center", "gap-2")}>
            <input
              type="checkbox"
